	...
	register_field_group(array(
	    ...
	    'fields' => array(
		    array(
		        ...
		        'name'          => 'carousel_image',
		        'type'          => 'image',
		        'instructions'  => __('Resize image to 540px x 464px.'),
		    ),
		    array(
	    ...
	    'fields' => array(
	      ...
	      array(
	        ...
	        'sub_fields' => array(
	          ...
	          array(
							'key'               => '547382598_acf_brand_flavor_lid_cup_image',
							'label'             => 'Flavor Cup',
							'name'              => 'flavor_lid_cup_image',
							'type'              => 'image',
							'instructions'      => 'Add Flavor Cup Image. Resize to 250px x 250px',
							'required'          => 0,
							'conditional_logic' => 0,
							'column_width'      => '',
							'return_format'     => 'url',
